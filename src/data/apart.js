const apartData = [{
    ...
    image: process.env.PUBLIC_URL + "/images/apart0.jpg",
    ...
    image: process.env.PUBLIC_URL + "/images/apart1.jpg",
    ...
    image: process.env.PUBLIC_URL + "/images/apart2.jpg",
    ...
    image: process.env.PUBLIC_URL + "/images/apart3.jpg",
    ...
    image: process.env.PUBLIC_URL + "/images/apart4.jpg",
    ...
    image: process.env.PUBLIC_URL + "/images/apart5.jpg",
